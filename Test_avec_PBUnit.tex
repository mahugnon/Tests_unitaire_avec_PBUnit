...
\begin{figure}[!htbp]
  ...
  \begin{figure}[!htbp]
    \begin{center}
    \includegraphics[width=1\linewidth]{./chooseTestTarget.png}
...
\begin{figure}[!htbp]
    \begin{center}
    \includegraphics[width=1\linewidth]{./choosetestbaselibraries.png}
...
\begin{figure}[!htbp]
    \begin{center}
    \includegraphics[width=1\linewidth]{./createTestLibrary.png}
